...
################################################################
# This is a generated script based on design: axil
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set axil_aclk [ create_bd_port -dir I -type clk -freq_hz 250000000 axil_aclk ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {axil_s0} \
  ...
  connect_bd_intf_net -intf_net S00_AXI_0_1 [get_bd_intf_ports axil_s0] [get_bd_intf_pins interconnect_axi/S00_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets S00_AXI_0_1] [get_bd_intf_ports axil_s0] [get_bd_intf_pins ila_s0/SLOT_0_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_interconnect_0_M00_AXI] [get_bd_intf_pins ila_m0/SLOT_0_AXI] [get_bd_intf_pins interconnect_axi/M00_AXI]
  ...
  connect_bd_net -net s_axi_aclk_0_1 [get_bd_ports axil_aclk] [get_bd_pins bram_ctrl_axi/s_axi_aclk] [get_bd_pins ila_m0/clk] [get_bd_pins ila_s0/clk] [get_bd_pins interconnect_axi/ACLK] [get_bd_pins interconnect_axi/M00_ACLK] [get_bd_pins interconnect_axi/S00_ACLK]
  connect_bd_net -net s_axi_aresetn_0_1 [get_bd_ports axil_aresetn] [get_bd_pins bram_ctrl_axi/s_axi_aresetn] [get_bd_pins interconnect_axi/ARESETN] [get_bd_pins interconnect_axi/M00_ARESETN] [get_bd_pins interconnect_axi/S00_ARESETN]

  # Create address segments
  assign_bd_address -offset 0x00000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces axil_s0] [get_bd_addr_segs bram_ctrl_axi/S_AXI/Mem0] -force
